...
<section className="max-w-4xl mx-auto py-6 "
    ...
    <h2 className="flex justify-center font-semibold py-4 mx-[30%] text-2xl text-blue-600"
                    ...
                    <p className="text-2xl mx-10 flex justify-center font-medium">Our mission is to provide compassionate, high-quality healthcare to our community,
